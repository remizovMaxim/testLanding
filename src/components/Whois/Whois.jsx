            ...
            <div className="whois_list container">
                <div className="list_item">
                    <div className="item_photo">
                        <img src={whois1} className='item_photo-img' alt="photoStaff" />
                ...
                <div className="list_item">
                    <div className="item_photo">
                        <img src={whois2} className='item_photo-img' alt="photoStaff" />
                        <div className="item_photo-hover">
                            <Link to='#'><img src={inst} className='item_photo-hover_icon' alt="icon" /></Link>
                            <Link to='#'><img src={inst} className='item_photo-hover_icon' alt="icon" /></Link>
                            <Link to='#'><img src={inst} className='item_photo-hover_icon' alt="icon" /></Link>
                ...
                <div className="list_item">
                    <div className="item_photo">
                        <img src={whois3} className='item_photo-img' alt="photoStaff" />
                        <div className="item_photo-hover">
                            <Link to='#'><img src={inst} className='item_photo-hover_icon' alt="icon" /></Link>
                            <Link to='#'><img src={inst} className='item_photo-hover_icon' alt="icon" /></Link>
                            <Link to='#'><img src={inst} className='item_photo-hover_icon' alt="icon" /></Link>
